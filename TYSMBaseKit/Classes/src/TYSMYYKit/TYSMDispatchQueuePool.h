...
#ifndef TYSMDispatchQueuePool_h
#define TYSMDispatchQueuePool_h
 ...
 */
@interface TYSMDispatchQueuePool : NSObject
...
extern dispatch_queue_t TYSMDispatchQueueGetForQOS(NSQualityOfService qos);
