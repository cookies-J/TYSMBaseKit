 ...
 Sample Code:
     ...
     ********************** json convertor *********************
     ...
     int main() {
         ...
         TYSMBook *book = [TYSMBook modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
     ...
     ********************** Coding/Copying/hash/equal *********************
     ...
     - (id)tysm_copyWithZone:(NSZone *)zone { return [self modelCopy]; }
     - (NSUInteger)tysm_hash { return [self modelHash]; }
     - (BOOL)tysm_isEqual:(id)object { return [self modelIsEqual:object]; }
     @end
