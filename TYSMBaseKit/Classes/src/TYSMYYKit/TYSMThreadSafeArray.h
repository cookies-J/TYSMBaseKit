...
/**
 ...
 @discussion It's also compatible with the custom methods in `NSArray(TYSMAdd)`
 and `NSMutableArray(TYSMAdd)`
 ...
 */
@interface TYSMThreadSafeArray : NSMutableArray
