...
typedef NS_ENUM(NSUInteger, TYSMReachabilityStatus) {
    TYSMReachabilityStatusNone  = 0, ///< Not Reachable
    TYSMReachabilityStatusWWAN  = 1, ///< Reachable via WWAN (2G/3G/4G)
    TYSMReachabilityStatusWiFi  = 2, ///< Reachable via WiFi
};

typedef NS_ENUM(NSUInteger, TYSMReachabilityWWANStatus) {
    TYSMReachabilityWWANStatusNone  = 0, ///< Not Reachable vis WWAN
    TYSMReachabilityWWANStatus2G = 2, ///< Reachable via 2G (GPRS/EDGE)       10~100Kbps
    TYSMReachabilityWWANStatus3G = 3, ///< Reachable via 3G (WCDMA/HSDPA/...) 1~10Mbps
    TYSMReachabilityWWANStatus4G = 4, ///< Reachable via 4G (eHRPD/LTE)       100Mbps
};


/**
 `TYSMReachability` can used to monitor the network status of an iOS device.
 */
@interface TYSMReachability : NSObject

@property (nonatomic, readonly) SCNetworkReachabilityFlags flags;                           ///< Current flags.
@property (nonatomic, readonly) TYSMReachabilityStatus status;                                ///< Current status.
@property (nonatomic, readonly) TYSMReachabilityWWANStatus wwanStatus NS_AVAILABLE_IOS(7_0);  ///< Current WWAN status.
...
@property (nullable, nonatomic, copy) void (^notifyBlock)(TYSMReachability *reachability);
