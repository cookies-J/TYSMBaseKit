...
/**
 ...
 @see    tysm_boundsForOrientation:
 */
- (CGRect)tysm_currentBounds NS_EXTENSION_UNAVAILABLE_IOS("");
...
/**
 ...
 e.g. (768,1024)
 */
@property (nonatomic, readonly) CGSize tysm_sizeInPixel;
...
/**
 ...
 Default value is 96.
 */
@property (nonatomic, readonly) CGFloat tysm_pixelsPerInch;
