...
/**
 ...
 @discussion It's also compatible with the custom methods in `NSDictionary(TYSMAdd)`
 and `NSMutableDictionary(TYSMAdd)`
 ...
 */
@interface TYSMThreadSafeDictionary : NSMutableDictionary
