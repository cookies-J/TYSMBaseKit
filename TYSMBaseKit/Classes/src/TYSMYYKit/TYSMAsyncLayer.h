...
@class TYSMAsyncLayerDisplayTask;

NS_ASSUME_NONNULL_BEGIN

/**
 The TYSMAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface TYSMAsyncLayer : CALayer
...
/**
 The TYSMAsyncLayer's delegate protocol. The delegate of the TYSMAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol TYSMAsyncLayerDelegate <NSObject>
@required
/// This method is called to return a new display task when the layer's contents need update.
- (TYSMAsyncLayerDisplayTask *)tysm_newAsyncDisplayTask;
@end


/**
 A display task used by TYSMAsyncLayer to render the contents in background queue.
 */
@interface TYSMAsyncLayerDisplayTask : NSObject
