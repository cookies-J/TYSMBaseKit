...
TYSMSYNTH_DUMMY_CLASS(NSData_TYSMAdd)


@implementation NSData (TYSMAdd)
...
- (NSString *)tysm_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)tysm_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)tysm_hmacMD5StringWithKey:(NSString *)key {
    return [self tysm_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)tysm_hmacMD5DataWithKey:(NSData *)key {
    return [self tysm_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)tysm_hmacSHA1StringWithKey:(NSString *)key {
    return [self tysm_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)tysm_hmacSHA1DataWithKey:(NSData *)key {
    return [self tysm_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)tysm_hmacSHA224StringWithKey:(NSString *)key {
    return [self tysm_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)tysm_hmacSHA224DataWithKey:(NSData *)key {
    return [self tysm_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)tysm_hmacSHA256StringWithKey:(NSString *)key {
    return [self tysm_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)tysm_hmacSHA256DataWithKey:(NSData *)key {
    return [self tysm_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)tysm_hmacSHA384StringWithKey:(NSString *)key {
    return [self tysm_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)tysm_hmacSHA384DataWithKey:(NSData *)key {
    return [self tysm_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)tysm_hmacSHA512StringWithKey:(NSString *)key {
    return [self tysm_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)tysm_hmacSHA512DataWithKey:(NSData *)key {
    return [self tysm_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)tysm_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)tysm_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)tysm_dataNamed:(NSString *)name {
