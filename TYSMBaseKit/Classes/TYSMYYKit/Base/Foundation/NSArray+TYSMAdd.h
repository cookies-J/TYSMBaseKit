 ...
 */
+ (nullable NSArray *)tysm_arrayWithPlistData:(NSData *)plist;
 ...
 */
+ (nullable NSArray *)tysm_arrayWithPlistString:(NSString *)plist;
 ...
 */
- (nullable id)tysm_objectOrNilAtIndex:(NSUInteger)index;
 ...
 */
@interface NSMutableArray (TYSMAdd)
...
/**
 ...
 @return A new array created from the binary plist data, or nil if an error occurs.
 */
+ (nullable NSMutableArray *)tysm_arrayWithPlistData:(NSData *)plist;
...
/**
 ...
 @return A new array created from the plist string, or nil if an error occurs.
 */
+ (nullable NSMutableArray *)tysm_arrayWithPlistString:(NSString *)plist;
 ...
 */
- (nullable id)tysm_popFirstObject;
...
/**
 ...
 @return The first object, or nil.
 */
- (nullable id)tysm_popLastObject;
