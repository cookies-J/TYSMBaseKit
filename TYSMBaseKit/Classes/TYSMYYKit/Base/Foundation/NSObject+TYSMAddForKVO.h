 ...
 */
@interface NSObject (TYSMAddForKVO)
 ...
 */
- (void)tysm_addObserverBlockForKeyPath:(NSString*)keyPath block:(void (^)(id _Nonnull obj, _Nullable id oldVal, _Nullable id newVal))block;
