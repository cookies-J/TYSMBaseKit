 ...
 */
- (nullable id)tysm_performSelectorWithArgs:(SEL)sel, ...;
 ...
 */
- (nullable id)tysm_performSelectorWithArgsOnMainThread:(SEL)sel waitUntilDone:(BOOL)wait, ...;
 ...
 */
- (nullable id)tysm_performSelectorWithArgs:(SEL)sel onThread:(NSThread *)thread waitUntilDone:(BOOL)wait, ...;
 ...
 */
- (void)tysm_setAssociateValue:(nullable id)value withKey:(void *)key;
...
/**
 ...
 @param key    The pointer to get value from `self`.
 */
- (void)tysm_setAssociateWeakValue:(nullable id)value withKey:(void *)key;
...
/**
 ...
 @param key The pointer to get value from `self`.
 */
- (nullable id)tysm_getAssociatedValueForKey:(void *)key;
 ...
 */
- (nullable id)tysm_deepCopyWithArchiver:(Class)archiver unarchiver:(Class)unarchiver;
