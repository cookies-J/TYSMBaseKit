 ...
 */
- (nullable UIImage *)tysm_snapshotImageAfterScreenUpdates:(BOOL)afterUpdates;
 ...
 */
- (void)tysm_setLayerShadow:(nullable UIColor*)color offset:(CGSize)offset radius:(CGFloat)radius;
 ...
 */
- (void)tysm_removeAllSubviews;

/**
 Returns the view's view controller (may be nil).
 */
@property (nullable, nonatomic, readonly) UIViewController *tysm_viewController;

/**
 Returns the visible alpha on screen, taking into account superview and window.
 */
@property (nonatomic, readonly) CGFloat tysm_visibleAlpha;
 ...
 */
- (CGPoint)tysm_convertPoint:(CGPoint)point toViewOrWindow:(nullable UIView *)view;
 ...
 */
- (CGPoint)tysm_convertPoint:(CGPoint)point fromViewOrWindow:(nullable UIView *)view;
 ...
 */
- (CGRect)tysm_convertRect:(CGRect)rect toViewOrWindow:(nullable UIView *)view;
...
/**
 ...
 @return The converted rectangle.
 */
- (CGRect)tysm_convertRect:(CGRect)rect fromViewOrWindow:(nullable UIView *)view;
...
@property (nonatomic) CGSize  tysm_size;        ///< Shortcut for frame.size.
