...
TYSMSYNTH_DUMMY_CLASS(UIApplication_TYSMAdd)
...
- (BOOL)isPirated {
    ...
    if (![self _tysm_fileExistInMainBundle:@"_CodeSignature"]) {
        return YES;
    }
    
    if (![self _tysm_fileExistInMainBundle:@"SC_Info"]) {
        return YES;
    }
...
- (BOOL)_tysm_fileExistInMainBundle:(NSString *)name {
...
TYSMSYNTH_DYNAMIC_PROPERTY_OBJECT(networkActivityInfo, setNetworkActivityInfo, RETAIN_NONATOMIC, _YYUIApplicationNetworkIndicatorInfo *);
