 ...
 */
@interface UIBezierPath (TYSMAdd)
...
/**
 ...
 [UIImage imageWithEmoji:size:] in `UIImage(TYSMAdd)`.
 ...
 */
+ (nullable UIBezierPath *)tysm_bezierPathWithText:(NSString *)text font:(UIFont *)font;
