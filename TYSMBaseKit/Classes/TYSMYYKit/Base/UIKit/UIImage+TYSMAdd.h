 ...
 */
+ (nullable UIImage *)tysm_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)tysm_imageWithPDF:(id)dataOrPath;
...
/**
 ...
 @return A new image create from PDF, or nil when an error occurs.
 */
+ (nullable UIImage *)tysm_imageWithPDF:(id)dataOrPath size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)tysm_imageWithEmoji:(NSString *)emoji size:(CGFloat)size;
 ...
 */
+ (nullable UIImage *)tysm_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)tysm_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)tysm_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock;
 ...
 */
- (nullable UIImage *)tysm_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)tysm_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)tysm_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)tysm_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 @param radius  The radius of each corner oval. Values larger than half the
                ...
                the width or height.
 */
- (nullable UIImage *)tysm_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)tysm_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)tysm_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)tysm_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)tysm_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)tysm_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)tysm_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)tysm_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 @return               image with effect, or nil if an error occurs (e.g. no
                       enough memory).
 */
- (nullable UIImage *)tysm_imageByBlurRadius:(CGFloat)blurRadius
