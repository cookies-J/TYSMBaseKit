...
TYSMSYNTH_DUMMY_CLASS(UIBezierPath_TYSMAdd)


@implementation UIBezierPath (TYSMAdd)

+ (UIBezierPath *)tysm_bezierPathWithText:(NSString *)text font:(UIFont *)font {
