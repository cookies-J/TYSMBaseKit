...
CGAffineTransform TYSMCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]) {
...
CGAffineTransform TYSMCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    after[0] = [from tysm_convertPoint:before[0] toViewOrWindow:to];
    after[1] = [from tysm_convertPoint:before[1] toViewOrWindow:to];
    after[2] = [from tysm_convertPoint:before[2] toViewOrWindow:to];
    
    return TYSMCGAffineTransformGetFromPoints(before, after);
}
