...
#import <TYSMYYKit/YYTextParser.h>
 ...
 */
@protocol TYSMTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (BOOL)textViewShouldBeginEditing:(TYSMTextView *)textView;
- (BOOL)textViewShouldEndEditing:(TYSMTextView *)textView;
- (void)textViewDidBeginEditing:(TYSMTextView *)textView;
- (void)textViewDidEndEditing:(TYSMTextView *)textView;
- (BOOL)textView:(TYSMTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(TYSMTextView *)textView;
- (void)textViewDidChangeSelection:(TYSMTextView *)textView;

- (BOOL)textView:(TYSMTextView *)textView shouldTapHighlight:(TYSMTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(TYSMTextView *)textView didTapHighlight:(TYSMTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(TYSMTextView *)textView shouldLongPressHighlight:(TYSMTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(TYSMTextView *)textView didLongPressHighlight:(TYSMTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See TYSMTextAttribute.h and YYTextLayout.h for more information.
 */
@interface TYSMTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<TYSMTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is TYSMTextVerticalAlignmentTop.
 */
@property (nonatomic) TYSMTextVerticalAlignment textVerticalAlignment;
 ...
 */
@property (nullable, nonatomic, strong) id<TYSMTextParser> textParser;
...
@property (nonatomic) IBInspectable TYSMTextVerticalAlignment textVerticalAlignment;
