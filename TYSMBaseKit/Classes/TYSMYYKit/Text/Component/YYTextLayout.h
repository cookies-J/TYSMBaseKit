...
@property TYSMTextTruncationType truncationType;
 ...
 */
@interface TYSMTextLinePositionSimpleModifier : NSObject <YYTextLinePositionModifier>
...
@property (nullable, nonatomic, strong, readonly) NSArray<TYSMTextAttachment *> *attachments;
