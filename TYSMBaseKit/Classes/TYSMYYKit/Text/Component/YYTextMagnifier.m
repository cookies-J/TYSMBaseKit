...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathRef strokePath = CGPathCreateWithEllipseInRect(tysm_CGRectPixelHalf(rect), NULL);
        ...
        CGContextSaveGState(context); {
            ...
            CGContextSetLineWidth(context, tysm_CGFloatFromPixel(1));
...
#define kPadding tysm_CGFloatPixelHalf(6.0)
#define kRadius 6.0
#define kHeight 32.0
#define kArrow 14.0
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathMoveToPoint(arrowPath, NULL, size.width / 2 - kArrow, tysm_CGFloatPixelFloor(kPadding) + kHeight);
        CGPathAddLineToPoint(arrowPath, NULL, size.width / 2 + kArrow, tysm_CGFloatPixelFloor(kPadding) + kHeight);
