...
/**
 The text vertical aligmnent in container. Default is TYSMTextVerticalAlignmentCenter.
 */
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TYSMTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TYSMTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TYSMTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) TYSMTextAction highlightLongPressAction;
