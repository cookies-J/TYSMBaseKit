 ...
 */
@interface NSAttributedString (TYSMText)

/**
 Archive the string to data.
 @return Returns nil if an error occurs.
 */
- (nullable NSData *)tysm_archiveToData;
...
/**
 ...
 @return Returns nil if an error occurs.
 */
+ (nullable instancetype)tysm_unarchiveFromData:(NSData *)data;
 ...
 */
@property (nullable, nonatomic, copy, readonly) NSDictionary<NSString *, id> *tysm_attributes;
 ...
 */
- (nullable NSDictionary<NSString *, id> *)tysm_attributesAtIndex:(NSUInteger)index;
 ...
 */
- (nullable id)tysm_attribute:(NSString *)attributeName atIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) UIFont *tysm_font;
- (nullable UIFont *)tysm_fontAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *tysm_kern;
- (nullable NSNumber *)tysm_kernAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *tysm_color;
- (nullable UIColor *)tysm_colorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *tysm_backgroundColor;
- (nullable UIColor *)tysm_backgroundColorAtIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *tysm_strokeWidth;
- (nullable NSNumber *)tysm_strokeWidthAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *tysm_strokeColor;
- (nullable UIColor *)tysm_strokeColorAtIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSShadow *tysm_shadow;
- (nullable NSShadow *)tysm_shadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readonly) NSUnderlineStyle tysm_strikethroughStyle;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *tysm_strikethroughColor;
- (nullable UIColor *)tysm_strikethroughColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nonatomic, readonly) NSUnderlineStyle tysm_underlineStyle;
 ...
 */
@property (nullable, nonatomic, strong, readonly) UIColor *tysm_underlineColor;
- (nullable UIColor *)tysm_underlineColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *tysm_ligature;
- (nullable NSNumber *)tysm_ligatureAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSString *tysm_textEffect;
- (nullable NSString *)tysm_textEffectAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *tysm_obliqueness;
- (nullable NSNumber *)tysm_obliquenessAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *tysm_expansion;
- (nullable NSNumber *)tysm_expansionAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *tysm_baselineOffset;
- (nullable NSNumber *)tysm_baselineOffsetAtIndex:(NSUInteger)index;
 ...
 */
@property (nonatomic, readonly) BOOL tysm_verticalGlyphForm;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TYSMTextShadow *textShadow;
- (nullable TYSMTextShadow *)textShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TYSMTextShadow *textInnerShadow;
- (nullable TYSMTextShadow *)textInnerShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TYSMTextDecoration *textUnderline;
- (nullable TYSMTextDecoration *)textUnderlineAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TYSMTextDecoration *textStrikethrough;
- (nullable TYSMTextDecoration *)textStrikethroughAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TYSMTextBorder *textBorder;
- (nullable TYSMTextBorder *)textBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TYSMTextBorder *textBackgroundBorder;
- (nullable TYSMTextBorder *)textBackgroundBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 If there's `TYSMTextBackedStringAttributeName` attribute, the backed string will
 ...
 */
- (void)setTysm_attributes:(nullable NSDictionary<NSString *, id> *)attributes;
 ...
 */
- (void)setTysm_attribute:(NSString *)name value:(nullable id)value;
 ...
 */
- (void)setTysm_attribute:(NSString *)name value:(nullable id)value range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIFont *tysm_font;
- (void)tysm_setFont:(nullable UIFont *)font range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *tysm_kern;
- (void)tysm_setKern:(nullable NSNumber *)kern range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *tysm_color;
- (void)tysm_setColor:(nullable UIColor *)color range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *tysm_backgroundColor;
- (void)tysm_setBackgroundColor:(nullable UIColor *)backgroundColor range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *tysm_strokeWidth;
- (void)tysm_setStrokeWidth:(nullable NSNumber *)strokeWidth range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *tysm_strokeColor;
- (void)tysm_setStrokeColor:(nullable UIColor *)strokeColor range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0  YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSShadow *tysm_shadow;
- (void)tysm_setShadow:(nullable NSShadow *)shadow range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readwrite) NSUnderlineStyle tysm_strikethroughStyle;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *tysm_strikethroughColor;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TYSMTextShadow *textShadow;
- (void)setTextShadow:(nullable TYSMTextShadow *)textShadow range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TYSMTextShadow *textInnerShadow;
- (void)setTextInnerShadow:(nullable TYSMTextShadow *)textInnerShadow range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TYSMTextDecoration *textUnderline;
- (void)setTextUnderline:(nullable TYSMTextDecoration *)textUnderline range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TYSMTextDecoration *textStrikethrough;
- (void)setTextStrikethrough:(nullable TYSMTextDecoration *)textStrikethrough range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TYSMTextBorder *textBorder;
- (void)setTextBorder:(nullable TYSMTextBorder *)textBorder range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TYSMTextBorder *textBackgroundBorder;
- (void)setTextBackgroundBorder:(nullable TYSMTextBorder *)textBackgroundBorder range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nonatomic, readwrite) CGAffineTransform tysm_textGlyphTransform;
...
- (void)setTextBackedString:(nullable TYSMTextBackedString *)textBackedString range:(NSRange)range;
- (void)setTextBinding:(nullable TYSMTextBinding *)textBinding range:(NSRange)range;
- (void)setTextAttachment:(nullable TYSMTextAttachment *)textAttachment range:(NSRange)range;
- (void)tysm_setTextHighlight:(nullable TYSMTextHighlight *)textHighlight range:(NSRange)range;
- (void)tysm_setTextBlockBorder:(nullable TYSMTextBorder *)textBlockBorder range:(NSRange)range;
- (void)tysm_setTextRubyAnnotation:(nullable YYTextRubyAnnotation *)ruby range:(NSRange)range NS_AVAILABLE_IOS(8_0);
...
- (void)tysm_setTextHighlightRange:(NSRange)range
              ...
              backgroundColor:(nullable UIColor *)backgroundColor
                    ...
                    tapAction:(nullable TYSMTextAction)tapAction
              longPressAction:(nullable TYSMTextAction)longPressAction;
 ...
 */
+ (NSArray<NSString *> *)tysm_allDiscontinuousAttributeKeys;
