 ...
 */
@protocol TYSMTextParser <NSObject>
@required
/**
 ...
 */
@interface TYSMTextSimpleMarkdownParser : NSObject <TYSMTextParser>
 ...
 */
@interface TYSMTextSimpleEmoticonParser : NSObject <TYSMTextParser>
