 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `TYSMModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface TYSMAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation TYSMAuthor
     @end
 
     @interface TYSMBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) TYSMAuthor *author;
     @end
     @implementation TYSMBook
     @end
    
     int main() {
         // create model from json
         TYSMBook *book = [TYSMBook tysm_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book tysm_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface TYSMShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation TYSMShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self tysm_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self tysm_modelInitWithCoder:aDecoder]; }
     - (id)tysm_copyWithZone:(NSZone *)zone { return [self tysm_modelCopy]; }
     - (NSUInteger)tysm_hash { return [self tysm_modelHash]; }
     - (BOOL)tysm_isEqual:(id)object { return [self tysm_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (TYSMModel)
 ...
 */
+ (nullable instancetype)tysm_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "TYSMyy-MM-dd'T'HH:mm:ssZ", "TYSMyy-MM-dd HH:mm:ss" or "TYSMyy-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)tysm_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)tysm_modelToJSONObject;
 ...
 */
- (nullable NSData *)tysm_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)tysm_modelToJSONString;
 ...
 */
+ (nullable NSArray *)tysm_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (TYSMModel)
 ...
 */
+ (nullable NSDictionary *)tysm_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<TYSMModel>' to your class header.
 */
@protocol TYSMModel <NSObject>
@optional
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)tysm_modelCustomPropertyMapper;
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class TYSMShadow, TYSMBorder, TYSMAttachment;
 
        @interface TYSMAttributes
        @property NSString *name;
        ...
        @implementation TYSMAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [TYSMShadow class],
                     @"borders" : TYSMBorder.class,
                     @"attachments" : @"TYSMAttachment" };
        }
        @end
 
 @return A class mapper.
 */
+ (nullable NSDictionary<NSString *, id> *)tysm_modelContainerPropertyGenericClass;
...
/**
 ...
 Example:
        @class TYSMCircle, TYSMRectangle, TYSMLine;
 
        @implementation TYSMShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [TYSMCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [TYSMRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [TYSMLine class];
            } else {
                return [self class];
            }
        }
 ...
 */
+ (nullable Class)tysm_modelCustomClassForDictionary:(NSDictionary *)dictionary;
 ...
 */
+ (nullable NSArray<NSString *> *)tysm_modelPropertyBlacklist;
...
/**
 ...
 @return An array of property's name.
 */
+ (nullable NSArray<NSString *> *)tysm_modelPropertyWhitelist;

/**
 This method's behavior is similar to `- (BOOL)tysm_modelCustomTransformFromDictionary:(NSDictionary *)dic;`, 
 ...
 */
- (NSDictionary *)tysm_modelCustomWillTransformFromDictionary:(NSDictionary *)dic;
 ...
 */
- (BOOL)tysm_modelCustomTransformFromDictionary:(NSDictionary *)dic;
...
/**
 ...
 @return Returns YES if the model is valid, or NO to ignore this model.
 */
- (BOOL)tysm_modelCustomTransformToDictionary:(NSMutableDictionary *)dic;
