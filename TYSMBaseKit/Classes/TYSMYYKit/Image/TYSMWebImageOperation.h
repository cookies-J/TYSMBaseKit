 ...
 */
@interface TYSMWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) TYSMImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   TYSMWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(TYSMWebImageOptions)options
                          cache:(nullable TYSMImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable TYSMWebImageProgressBlock)progress
                      transform:(nullable TYSMWebImageTransformBlock)transform
                     completion:(nullable TYSMWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
