 ...
 */
inline static TYSMDisplayInfo TYSMDisplayInfoMake(CGSize resolution, CGFloat pixelsPerInch) {
    return (TYSMDisplayInfo){resolution, pixelsPerInch};
};
