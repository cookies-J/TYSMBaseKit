...
#import "TYSMDeviceInfoTypes_OSX.h"
...
/**
 System byte order, e.g. TYSMByteOrderLittleEndian.
 */
@property (assign, atomic, readonly) TYSMByteOrder        systemByteOrder;
