...
NSString * const kTYSM_CTMediatorParamsKeySwiftTargetModuleName = @"kTYSM_CTMediatorParamsKeySwiftTargetModuleName";

@interface TYSM_CTMediator ()

@property (nonatomic, strong) NSMutableDictionary *cachedTarget;

@end

@implementation TYSM_CTMediator

#pragma mark - public methods
+ (instancetype)sharedInstance
{
    static TYSM_CTMediator *mediator;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mediator = [[TYSM_CTMediator alloc] init];
...
- (id)performTarget:(NSString *)targetName action:(NSString *)actionName params:(NSDictionary *)params shouldCacheTarget:(BOOL)shouldCacheTarget
{
    ...
    NSString *swiftModuleName = params[kTYSM_CTMediatorParamsKeySwiftTargetModuleName];
...
TYSM_CTMediator* _Nonnull CT(void){
    return [TYSM_CTMediator sharedInstance];
};
